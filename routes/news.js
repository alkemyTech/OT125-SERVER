...
const {validatorCreate, validatorGetOne, validatorUpdate, validatorRemove, getAllValidator} = require('../middleware/newValidation');
const { getAll, getOne, create, update, remove} = require('../controllers/newsController');
const { isAdmin } = require('../middleware/isAdmin');
const { authenticate } = require('../middleware/authenticate');

router.get('/', authenticate, getAllValidator, getAll);
